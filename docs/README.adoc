...
To automaticaly deploy the VM we are using:
* Vagrant
* Ansible
...
* Adrián Bertos Gómez - Anonymous machine and SSL configuration
* Álvaro García Márquez - Mirror machine configuration
* Jesús Martínez Valero - DNS machine configuration
